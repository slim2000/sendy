...
<?php 
	if(get_app_info('is_sub_user')) 
	{
		...
		{
			echo '<script type="text/javascript">window.location="'.get_app_info('path').'/autoresponders-report.php?i='.get_app_info('restricted_to_app').'&a='.$_GET['a'].'&ae='.$_GET['ae'].'"</script>';
			exit;
		}
	}
?>
