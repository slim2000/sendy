			                    ...
			                    echo '
			                    	<tr id="'.$i.'">
					                  ...
					                  <script type="text/javascript">
										...
										if(c)
										{
											$.post("includes/list/delete-custom-field.php", { index: '.$i.', list: '.$_GET['l'].' },
											  function(data) {
											      if(data)
											      {
											      	if(data=="ares_used")
											      	...
											      	{
												      	$("#'.$i.'").fadeOut();
												      	window.location = "'.get_app_info('path').'/custom-fields?i='.get_app_info('app').'&l='.$_GET['l'].'";
												    }
											      }
											      else
											      {
...
<div id="edit-custom-field" class="modal hide fade">
    ...
    <div class="modal-body">
    	<form action="<?php echo get_app_info('path')?>/includes/list/edit-custom-field.php" method="POST" id="edit-form">
			...
			<input type="hidden" value="<?php echo $_GET['l']; ?>" name="lid">
